...
<style>
        ...
        h1.mb-3::after {
            ...
            width: 100%;
            height: 100%;
            background-image: url('your_animation.gif'); /* Replace 'your_animation.gif' with your actual GIF */
            animation: moveText 3s infinite; /* Adjust duration and timing */
                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <a href="menu.php" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Check our Menu!</a>
                        </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
					...
					<h1 class="mb-3">Kindly go to our Menu Section to process your order</h1>
                </div>
				<br>
